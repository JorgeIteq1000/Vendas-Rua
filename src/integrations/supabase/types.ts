    ...
    Tables: {
      customers: {
        Row: {
          ...
          status: string | null; // Adicionei status aqui por garantia tb
        };
        Insert: {
          cpf?: string | null;
          created_at?: string;
      ...
      profiles: {
        Row: {
          ...
          is_active: boolean | null; // Adicionei is_active por conta do Auth
        };
        Insert: {
          assigned_neighborhoods?: string[] | null;
          created_at?: string;
      ...
      visits: {
        Row: {
          ...
          updated_at: string;
          user_id: string;
          // 👇 Campos novos de visitas que criamos
